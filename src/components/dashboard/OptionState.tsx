                ...
                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <NavLink exact to="/Canada" className="navbar-brand">
                            <div className="row">
                                <div className="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                                    <img src="https://cdn.jsdelivr.net/gh/hjnilsson/country-flags@latest/svg/ca.svg" height="25px" alt="OptionStatsUS"/>
                                </div>
                    ...
                    <div className="col-xs-1 col-sm-1 col-md-1 col-lg-1 optionUSA" onClick={()=>{console.log("Goi China")}}>
                        <NavLink exact to="/China" className="navbar-brand">
                            <div className="row">
                                <div className="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                                    <img src="https://cdn.jsdelivr.net/gh/hjnilsson/country-flags@latest/svg/cn.svg" height="25px" alt="OptionStatsUS"/>
                                </div>
                                <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    <h3>China</h3>
                                </div>
                    ...
                    <div className="col-xs-1 col-sm-1 col-md-1 col-lg-1 optionUSA" onClick={()=>{console.log("Goi Australia")}}>
                        <NavLink exact to="/Australia" className="navbar-brand">
                            <div className="row">
                                <div className="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                                    <img src="https://cdn.jsdelivr.net/gh/hjnilsson/country-flags@latest/svg/au.svg" height="25px" alt="OptionStatsUS"/>
                                </div>
                                <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    <h3>Australia</h3>
                                </div>
                    ...
                    <div className="col-xs-1 col-sm-1 col-md-1 col-lg-1 optionUSA" onClick={()=>{console.log("Goi Italy")}}>
                        <NavLink exact to="/Italy" className="navbar-brand">
                            <div className="row">
                                <div className="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                                    <img src="https://cdn.jsdelivr.net/gh/hjnilsson/country-flags@latest/svg/it.svg" height="25px" alt="OptionStatsUS"/>
                                </div>
                                <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    <h3>Italy</h3>
                                </div>
                    ...
                    <div className="col-xs-1 col-sm-1 col-md-1 col-lg-1 optionUSA" onClick={()=>{console.log("Goi Russia")}}>
                        <NavLink exact to="/Russia" className="navbar-brand">
                            <div className="row">
                                <div className="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                                    <img src="https://cdn.jsdelivr.net/gh/hjnilsson/country-flags@latest/svg/ru.svg" height="25px" alt="OptionStatsUS"/>
                                </div>
                                <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    <h3>Russia</h3>
                                </div>
                    ...
                    <div className="col-xs-1 col-sm-1 col-md-1 col-lg-1 optionUSA" onClick={()=>{console.log("Goi Ireland")}}>
                        <NavLink exact to="/Ireland" className="navbar-brand">
                            <div className="row">
                                <div className="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                                    <img src="https://cdn.jsdelivr.net/gh/hjnilsson/country-flags@latest/svg/ie.svg" height="25px" alt="OptionStatsUS"/>
                                </div>
                                <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    <h3>Ireland</h3>
                                </div>
