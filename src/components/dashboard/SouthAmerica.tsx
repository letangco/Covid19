...
import {fetchSouthAmericaData,SummaryStats,fetchSouthAmericaSummaryData} from '../../api/dashboard/index';
interface IProps{
}
interface IState{
    dataStats: any [],
...
class SouthAmerica extends Component <{}, IState> {
    ...
    componentDidMount(){
        const fetchMyAPI = async () => {
            const initialDailyData:any = await fetchSouthAmericaData();
            this.setState({
          ...
          const fetchMyAPI_Summary_Total = async () => {
            const initialDailyData:any = await fetchSouthAmericaSummaryData();
            this.setState({
    ...
    return (
                    <div className="panel panel-warning">
                          <div className="panel-heading">
                                <h4>South America COVID-19 Stats</h4>
                          </div>
