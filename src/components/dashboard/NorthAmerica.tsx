...
import {fetchNorthAmericaData,SummaryStats,fetchNorthAmericaSummaryData} from '../../api/dashboard/index';
interface IProps{
}
interface IState{
    dataStats: any [],
...
class NorthAmerica extends Component <{}, IState> {
    ...
    componentDidMount(){
        const fetchMyAPI = async () => {
            const initialDailyData:any = await fetchNorthAmericaData();
            this.setState({
          ...
          const fetchMyAPI_Summary_Total = async () => {
            const initialDailyData:any = await fetchNorthAmericaSummaryData();
            this.setState({
    ...
    return (
                    <div className="panel panel-warning">
                          <div className="panel-heading">
                                <h4>North America COVID-19 Stats</h4>
                          </div>
                          <div className="panel-body divtableStats">
                                <Table className="tableStats" tableLayout="auto" size="large" columns={columns1}  dataSource={data2} onChange={this.handleChange} />
                          </div>
